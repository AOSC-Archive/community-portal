  ...
  <body>
    ...
    <div class="container">
      ...
      <img src="/img/aosc.png" height="150" width="150" align=right hspace="40" >
        <h1 class="blog-title WQYMicroHei">News</h1>
        <p class="lead blog-description WQYMicroHei">Freshly off the shelf</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 blog-main WQYMicroHei">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title WQYMicroHei">Anthon Starter 0.1.2.0 Hits Green</h2>
            <p class="lead blog-description WQYMicroHei">July 11th, 2014</p>
            ...
            <p>For more information please check out the <a href="https://projects-dev.anthonos.org/anthon-starter">Anthon Starter Homepage</a>.
          </div>

          <div class="blog-post">
            <h2 class="blog-post-title WQYMicroHei">AnthonOS Final Release "Doge"</h2>
            <p class="lead blog-description WQYMicroHei">July 10th, 2014</p>
            ...
            <p>For more information please check out the <a href="https://projects-dev.anthonos.org/aosc-os">AOSC OS Homepage</a>.
          </div>
