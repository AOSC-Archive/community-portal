      ...
      <div class="row">
        ...
        <div class="col-sm-9 blog-main">
          ...
          <div class="blog-post">
            ...
            <ul>
              <li> AnthonOS, for desktop-oriented Linux distribution</li>
              <li> CentralPoint, for server-oriented Linux distribution</li>
              <li> Nirvana, for RPM branch of desktop-oriented Linux distribution</li>
            </ul>
          </div>
          ...
          <div class="blog-post">
            ...
            <p>This version of AnthonOS is only a Debian derivative with customized KDE desktop, and it was never maintained after its
            final release as a measure to kickstart AOSC OS2 to make CentralPoint and AnthonOS into a unified distribution.
          </div>
