  ...
  <?php include '../templates/aosc-os/navbar.php';?>
    ...
    <div class="container">
      ...
      <img src="/img/os3.svg" height="150" width="150" align=right hspace="40" >
        ...
        <p class="lead blog-description WQYMicroHei">Origin of Better and Faster Linux Distribution</p>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-8 blog-main WQYMicroHei">
          ...
          <div class="blog-post">
            <h2 class="blog-post-title WQYMicroHei">What's new...</h2>
            <p class="blog-post-meta WQYMicroHei">as of now<p>
          ...
          <div class="blog-post">
            ...
            <p class="blog-post-meta WQYMicroHei">as of tomorrow<p>
